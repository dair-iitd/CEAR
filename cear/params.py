...
def add_args(parser):
    ...
    parser.add_argument('--decreasing_order', action= 'store_true')
    parser.add_argument('--analyze_results', action= 'store_true')
    parser.add_argument('--compute_entity_distance', action= 'store_true')
    parser.add_argument('--remove_closest', type=int)
